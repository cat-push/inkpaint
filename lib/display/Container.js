...
class Container extends _DisplayObject.default {
  ...
  _renderWebGL(renderer) {// this is where content itself gets rendered...
  }

  _renderCanvas(renderer) {// this is where content itself gets rendered...
  }
